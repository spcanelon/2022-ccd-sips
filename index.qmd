...
The next step is to use geocoding to convert the restaurant/bar addresses to geographical coordinates (longitude and latitude) that we can map. We can use the [tidygeocoder](https://jessecambon.github.io/tidygeocoder) package to help us, and specify that we want to use the [Nominatum](https://nominatim.org/) open source geocoding service.
